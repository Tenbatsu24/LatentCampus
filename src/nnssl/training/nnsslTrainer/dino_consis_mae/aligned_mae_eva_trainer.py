...
from nnssl.architectures.dino_consis_arch import DINOConsisEvaMAE
...
class BaseDinoConsisEvaMaeTrainer(BaseEvaMAETrainer):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.teacher = None
        self.teacher_mom = 0.95  # Momentum for the teacher model
...
class DinoConsisEvaMaeEvaTrainer(BaseDinoConsisEvaMaeTrainer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        super().__init__(*args, **kwargs)
        self.teacher_mom = 0.95
        self.total_batch_size = 4
        self.initial_lr = 3e-4  # Initial learning rate for the optimizer
        self.num_epochs = 500
        self.warmup_duration_whole_net = 50  # Warmup duration for the whole network
...
class DinoConsisFTEvaMAETrainer(DinoConsisEvaMaeEvaTrainer):
