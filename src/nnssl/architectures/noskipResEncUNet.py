...
class ResidualEncoderUNet_noskip(nn.Module):
    def __init__(self,
        ...
        self.encoder = ResidualEncoder(input_channels, n_stages, features_per_stage, conv_op, kernel_sizes, strides,
                                       ...
                                       return_skips=False, disable_default_stem=False, stem_channels=stem_channels)
        self.decoder = UNetDecoder_noskip(self.encoder, num_classes, n_conv_per_stage_decoder)
