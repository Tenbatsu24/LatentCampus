...
def get_output_folder(dataset_name_or_id: Union[str, int], trainer_name: str = 'nnsslTrainer',
                      plans_identifier: str = 'nnsslPlans', configuration: str = '3d_fullres',
                      fold: Union[str, int] = None) -> str:
    tmp = join(nnssl_results, maybe_convert_to_dataset_name(dataset_name_or_id),
